...
# get the free proxies list
def getProxies():
    response = requests.get('https://free-proxy-list.net/')
    scarpy_content = BeautifulSoup(response.content, 'html.parser')
    table = scarpy_content.find('tbody')
    proxies = []
    for row in table:
...
def extract(proxy):
    ...
    try:
        ...
        print("Unfortunatlly, This proxy doesn't work!")
...
# Mapping them in futures super quick
